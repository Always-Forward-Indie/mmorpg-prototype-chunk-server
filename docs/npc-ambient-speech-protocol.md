...
| `questStates` | `QuestManager::getCharacterQuestStates()` |
| `questCurrentStep` | `QuestManager::getCharacterQuestCurrentSteps()` |
| `questProgress` | `QuestManager::getCharacterQuestProgress()` |
| `flagsBool` / `flagsInt` | `CharacterManager` (flags из персонажа) |
