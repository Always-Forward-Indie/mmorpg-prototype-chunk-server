...
void EventDispatcher::dispatch(const EventContext& context, std::shared_ptr<boost::asio::ip::tcp::socket> socket) 
{
...
void EventDispatcher::handleJoinGame(const EventContext& context, std::shared_ptr<boost::asio::ip::tcp::socket> socket) {
...
void EventDispatcher::handleMoveCharacter(const EventContext& context, std::shared_ptr<boost::asio::ip::tcp::socket> socket) {
    Event moveEvent(Event::MOVE_CHARACTER_CLIENT, context.clientData.clientId, context.characterData, socket);
...
void EventDispatcher::handleDisconnect(const EventContext& context, std::shared_ptr<boost::asio::ip::tcp::socket> socket) {
...
void EventDispatcher::handlePing(const EventContext& context, std::shared_ptr<boost::asio::ip::tcp::socket> socket) {
    Event pingEvent(Event::PING_CLIENT, context.clientData.clientId, context.clientData, socket);
    eventQueuePing_.push(pingEvent);
}

void EventDispatcher::handleGetSpawnZones(const EventContext& context, std::shared_ptr<boost::asio::ip::tcp::socket> socket) {
    if (!chunkServer_) {
...
void EventDispatcher::handleGetConnectedClients(const EventContext& context, std::shared_ptr<boost::asio::ip::tcp::socket> socket) {
    Event getConnectedClientsEvent(Event::GET_CONNECTED_CHARACTERS_CHUNK, context.clientData.clientId, gameServices_.getClientManager().getClientsList(), socket);
